"""Portfolio data served to the frontend."""
...
PORTFOLIO_DATA = {
    "profile": {
        ...
        "summary": (
            "Desenvolvedor Sênior com forte atuação em arquitetura de sistemas, "
            "liderança técnica e desenvolvimento de aplicações escaláveis. "
            "Especialista em Python, JavaScript, bancos SQL e NoSQL, padrões "
            "de projeto e arquitetura de software. Experiência sólida em "
            "infraestrutura, redes e virtualização (Linux, MikroTik, Proxmox), "
            "atuando com visão completa de produto: da arquitetura ao deploy em produção."
        ),
    },
    "skills": [
